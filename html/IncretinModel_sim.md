...
<div>
  ...
  - [Parameters initialization](#2)
  - [- Study A1: GIP or GLP1 infusion at basal glucose - NGT
    subjects](#4)
  - [- Study A2: saline, GIP or GLP1 infusion at basal glucose - T2D
    subjects](#5)
  - [- Study B1: hiperglycemic clamp (HGC) with saline, GIP infusion or
    GLP1 infusion at different doses - NGT subjects](#6)
  - [- Study B1: hiperglycemic clamp (HGC) with saline, GIP infusion or
    GLP1 infusion at different doses - T2D subjects](#7)
  - [- Study B2: hyperglicaemic clamp (HGC) with saline, GIP or GLP1
    infusion - NGT subjects](#8)
  - [- Study B2: hyperglicaemic clamp (HGC) with saline, GIP or GLP1
    infusion - T2D subjects (pre glucose normalization)](#9)
  - [- Study B2: plot cpeptide](#10)
  - [- Study B3: hiperglycemic clamp (HGC) with saline or GIP infusion -
    NGT subjects](#11)
  - [- Study B3: hiperglycemic clamp (HGC) with saline, GIP infusion at
    different doses or GLP1 infusion - T2D subjects](#12)
  - [- Study B4: hyperglicaemic clamp (HGC) with boluses and infusion of
    GIP at different doses - NGT subjects](#13)
  - [- Study B4: hyperglicaemic clamp (HGC) with boluses and infusion of
    GIP at different doses - T2D subjects](#14)
  - [- Study C1: glucose ramp with saline infusion or GLP1 infusion at
    different doses - NGT subjects](#15)
  - [- Study C1: glucose ramp with saline infusion or GLP1 infusion at
    different doses - T2D subjects](#16)
  - [- Study D1: OGTT and Intravenous glucose infusion simulating an
    OGTT with saline, GIP or GLP1 infusion - NGT subjects](#17)
  - [Data analysis](#20)
...
## Parameters initialization<span id="2"></span>

The parameters are the result of the fit to the experimental data (see
below for the list of publications).

Each dataset (related to a specific experimental condition) and the
corresponding reference parameter vector are saved in a different file
.mat.
...
The vector p\_peak is held fixed p\_peak(1)--\> p19 in the equation of
the article p\_peak(2)--\> p20 in the equation of the
article

## \- Study A1: GIP or GLP1 infusion at basal glucose - NGT subjects<span id="4"></span>
...
![](IncretinModel_sim_01.png)

## \- Study A2: saline, GIP or GLP1 infusion at basal glucose - T2D subjects<span id="5"></span>
...
![](IncretinModel_sim_02.png)
![](IncretinModel_sim_03.png)

## \- Study B1: hiperglycemic clamp (HGC) with saline, GIP infusion or GLP1 infusion at different doses - NGT subjects<span id="6"></span>
...
![](IncretinModel_sim_04.png)
![](IncretinModel_sim_05.png)

## \- Study B1: hiperglycemic clamp (HGC) with saline, GIP infusion or GLP1 infusion at different doses - T2D subjects<span id="7"></span>
...
![](IncretinModel_sim_06.png)
![](IncretinModel_sim_07.png)

## \- Study B2: hyperglicaemic clamp (HGC) with saline, GIP or GLP1 infusion - NGT subjects<span id="8"></span>
...
![](IncretinModel_sim_08.png)

## \- Study B2: hyperglicaemic clamp (HGC) with saline, GIP or GLP1 infusion - T2D subjects (pre glucose normalization)<span id="9"></span>
...
![](IncretinModel_sim_09.png)

## \- Study B2: plot cpeptide<span id="10"></span>
...
![](IncretinModel_sim_10.png)

## \- Study B3: hiperglycemic clamp (HGC) with saline or GIP infusion - NGT subjects<span id="11"></span>
...
![](IncretinModel_sim_11.png)
![](IncretinModel_sim_12.png)

## \- Study B3: hiperglycemic clamp (HGC) with saline, GIP infusion at different doses or GLP1 infusion - T2D subjects<span id="12"></span>
...
![](IncretinModel_sim_13.png)
![](IncretinModel_sim_14.png)

## \- Study B4: hyperglicaemic clamp (HGC) with boluses and infusion of GIP at different doses - NGT subjects<span id="13"></span>
...
![](IncretinModel_sim_15.png)

## \- Study B4: hyperglicaemic clamp (HGC) with boluses and infusion of GIP at different doses - T2D subjects<span id="14"></span>
...
![](IncretinModel_sim_16.png)

## \- Study C1: glucose ramp with saline infusion or GLP1 infusion at different doses - NGT subjects<span id="15"></span>
...
![](IncretinModel_sim_17.png)
![](IncretinModel_sim_18.png)

## \- Study C1: glucose ramp with saline infusion or GLP1 infusion at different doses - T2D subjects<span id="16"></span>
...
![](IncretinModel_sim_19.png)
![](IncretinModel_sim_20.png)

## \- Study D1: OGTT and Intravenous glucose infusion simulating an OGTT with saline, GIP or GLP1 infusion - NGT subjects<span id="17"></span>
...
![](IncretinModel_sim_22.png) ![](IncretinModel_sim_23.png)
![](IncretinModel_sim_24.png)

## Data analysis<span id="20"></span>

For each test we created a vector containing 6 elements: - element 1 of
the vector: GIP or GLP1 infusion rate (pmol/kg/min) - element 2 of the
vector GIP or GLP1 basal concentration (pmol/L) - total GIP or GLP1 -
element 3 of the vector: AUC Kincr - element 4 of the vector: AUC
calcium transient due to the incretin effect (nmol/L) - element 5 of the
vector: AUC glu during the incretins stimulus (mmol/L) - element 6 of
the vecotr: AUC of GIP or GLP1 concentration (pmol/L) - total GIP or
GLP1 The vectors are saved in the file
analysis\_all\_tests
...
![](IncretinModel_sim_25.png) ![](IncretinModel_sim_26.png)
